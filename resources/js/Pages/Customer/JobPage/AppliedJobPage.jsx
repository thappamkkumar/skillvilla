   ...
   useJobDeleteWebsocket( logedUserData );
	...
	const apiCall = useCallback(async()=>{ 
		try
		{
			...
			let url = `/get-applied-job-vacancies?cursor=${jobList.cursor}`;
	...
	return ( 
		<>
			<PageSeo 
				title="Applied Jobs | SkillVilla"
				description="View the jobs you’ve applied to on SkillVilla."
				keywords="applied jobs, job applications, SkillVilla"
			/>
			...
			>
				...
				</div>
				{
					 ...
					 (
							<div className="    px-2   px-sm-3 px-md-4 px-lg-5  py-2  ">
							<p className="no_posts_message  ">You haven't applied for any job yet.</p>
							</div>
					 ):(
						<>
