...
const SavedFreelancePage = () => { 
	...
	const apiCall = useCallback(async()=>{ 
		try
		{
			...
			let url = `/get-saved-freelance-work?cursor=${freelanceList.cursor}`;
	...
	return ( 
		<>
			<PageSeo 
				title="Saved Freelance Gigs | SkillVilla"
				description="Access the freelance gigs you've saved for later on SkillVilla."
				keywords="saved gigs, freelance, bookmarked gigs, SkillVilla"
			/>
			...
			>
				<div className="    px-2   px-sm-3 px-md-4 px-lg-5  py-2  ">
					<h3 className="fw-bold  ">Saved Freelance Gigs</h3>
				</div>
			
				{
					...
					(
						<div className="    px-2   px-sm-3 px-md-4 px-lg-5  py-2  ">
							<p className="no_posts_message  ">You haven't saved   any freelance work or task yet.</p>
						</div>
					):(
...
export default SavedFreelancePage;
