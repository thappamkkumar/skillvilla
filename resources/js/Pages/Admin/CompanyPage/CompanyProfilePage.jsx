...
import Col from 'react-bootstrap/Col';
 ...
 import CompanyProfileAbout from '../../../Components/Admin/Company/CompanyProfileAbout';
...
const CompanyProfilePage = () => { 
	...
	return ( 
		<>
			<PageSeo 
			title={companyProfile?.name ? `${companyProfile.name} | Admin | SkillVilla` : 'Company Profile | Admin | SkillVilla'}
			description={companyProfile?.name ? `Admin view of the company "${companyProfile.name}" on SkillVilla.` : 'View and manage company profiles from the admin panel.'}
			keywords={companyProfile?.name ? `admin company, ${companyProfile.name}, SkillVilla, manage company profile` : 'admin company, SkillVilla, company profile, admin view'}
		/>
