...
const UpdateCompanyProfileLogo = ({ id, setCompanyProfile}) => {
        ...
        const formData = new FormData();
				...
				try { 
					...
					{  
						...
						setSubmitionMSG("Company logo is update successfully");  
						 
						
						setCompanyProfile((prev) => ({
							...prev,
							logo: data.logo + '?timestamp=' + new Date().getTime(),
						}));
					...
					{
						setSubmitionMSG('Failed to update company logo. Please try again.');
    ...
    }, [id, authToken, setCompanyProfile]);
...
export default memo(UpdateCompanyProfileLogo);
